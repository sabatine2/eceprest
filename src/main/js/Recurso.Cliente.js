	...
	endpoints: [
		...
		},
		{
			...
			params: [
				...
				{
					name: "status",
					description: "Filstrar pelo status do cliente. Valor padrão: \"2\""
				}
			]
		},
		{
		...
		},
		{
			...
			params: [
				{
					name: "razao",
					description: "Efetua uma busca pelo nome ou razão social do cliente. Mínimo de três caracteres.",
					type: "string",
				},
				{
					name: "fantasia",
					description: "Efetua uma busca pelo sobrenome ou nome fantasia do cliente. Mínimo de três caracteres.",
					type: "string",
				},
				{
					name: "cnpjcpf",
					description: "Efetua uma busca pelo cpf ou cnpj do cliente. Mínimo de três caracteres.",
					type: "string",
				},
				{
					name: "codigo",
					description: "Efetua uma busca pelo código do cliente. Mínimo de três caracteres.",
					type: "string",
				},
				{
					name: "since",
