	...
	endpoints: [
		{
			...
			params: [
				...
				{
					name: "dataAlteracao",
					description: "Data da ultima alteração do serviço.",
					type: "long [UNIX timestamp]"
				},
				{
					name: "statusModel",
				...
				},
				{
					...
					description: "Flag que determina se o serviço pode ser excluido.",
					type: "boolean",
					insert: true
				},
				{
		...
		},
		{
			...
			description: "Ao utilizar o método POST na URL acima, é possivel criar um serviço novo.",
		},
		{
			label: "Lista",
			url: "/servico",
			...
			params: [
				{
					name: "since",
					description: "Filtrar pela data da ultima alteracao da Base de Conhecimento. Formato mm/dd/yyy. Valor padrão: \"01/01/1900\"."
				},
				{
					name: "offset",
					description: "Filtrar a partir do numero de um resultado especifico. Valor padrão: \"0\"."
				},
				{
					name: "limit",
					description: "Limitar o numero de resultados buscados. Valor padrão: \"100\"."
				},
				{
					name: "status",
